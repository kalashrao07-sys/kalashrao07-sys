...
followers, commits, top languages) and renders a dark, monospace SVG
stat card at stats/kalash_stats.svg, embedded in the README.

Run locally:
    ACCESS_TOKEN=ghp_xxx python3 generate_stats.py

Run in CI: see .github/workflows/update-stats.yml
"""
